...
describe('docker verifyConditions plugin', function() {
  ...
  it('should throw when the username is not set', function() {
    ...
    return expect(verifyConditions({prepare: {registryUrl: '', imageName: ''}}, logger)).to.eventually.be
  ...
  it('should use the registry from the config', function() {
    ...
    return expect(verifyConditions({prepare: {registryUrl: 'my_private_registry', imageName: ''}}, logger))
